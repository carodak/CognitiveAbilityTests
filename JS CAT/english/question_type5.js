...
window.addEventListener('DOMContentLoaded', (event) => {
  ...
  function DisplaySequence() {
    ...
    document.getElementById("sub-title").innerHTML = "<div class='question'>Working memory test: Your turn!</div>";
    document.getElementById("nbdigits").innerHTML = nbDigits + " digits to memorize: ";
  ...
  function NextLevel() {
    ...
    document.getElementById("nbdigits").innerHTML = "Next level, increasing difficulty." + nbDigits + "digits to memorize.";
...
function DisplayEndExperiment() {
  ...
  document.getElementById("output").innerHTML = "The experiment is over, thank you for your participation!";
  inputNbr.style.display = "none";
}
