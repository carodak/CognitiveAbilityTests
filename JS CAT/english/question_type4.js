...
window.addEventListener('DOMContentLoaded', (event) => {
  ...
  function CreateQuestionList() {
    myQuestions = [
      {
        exemple: true,
        question: "We are going to show two grids. On this first grid, there are 2 blue circles and one red. You must memorize where the blue circles are and ignore the red circle. After 3 seconds, we move on to the next grid." ,
        image: "questions/QT4-0-0.png"
      },
      {
        exemple: true,
        question: "On this second grid, there is only a blue circle. You must memorize where this circle is in 3 seconds.",
        image: "questions/QT4-0-1.png"
      },
      {
        exemple: true,
        question: "You must now place on the grid the blue circles which were not in the same position in the two grids. You must place a gray circle where the circles were repeated. The red circles are ignored. Here is the solution:",
        image: "questions/QT4-0-2.png"
      },

      {
        question: "Memorize the location of the blue circles and ignore the red circles if there are any. ",
      ...
      {
        question: "Draw in blue the location of the blue circles that did not repeat in the two grids. Draw in gray the blue circles found in the two grids. Ignore the red circles."
      },
      {
  ...
  */
  ...
  function AddHTMLElements(currentQuestion) {
    if (currentQuestion.exemple) {
      output.push(
        `<div class="slide">
            <div class="question">Part 4 Spatial memory test: Example</div>
      ...
      output.push(
        `<div class="slide">
            <div class="question">Part 4 Spatial memory test: Your turn!</div>
            <p>${currentQuestion.question}</p>
           <div class="image"><img src=${currentQuestion.image} height=45% width=45%></div>
         </div>`
      );
