...
window.addEventListener('DOMContentLoaded', (event) => {
  ...
  function CreateQuestionList() {
    myQuestions = [
      {
        exemple: true,
        question: "Here is a set of abstract geometric figures. To find the missing figure (A to H),\
        try to <mark> deduce relationships between figures </mark>. Starting from the first column on the left and going down, \
        it can be seen that the segment (I-II-III) is increased each time. This increase is repeated with the other columns. \
        With the same reason, we see that in the lines only the position of the segment changes. \
        The diagonals combine position and increase of the segments. Answer B is the only one that respects the rules of increase and position \
        that we discovered.",
        image: "questions/QT1-0.png"
      },
      {
        question: "What is the missing figure?",
        image: "questions/QT1-1.png",
        answers: ["A", "B", "C", "D", "E", "F", "G", "H"],
        correctAnswer: "G"
      },
      {
        question: "<p> <mark> Confusion is a situation in which people do not understand what is going on, what they should do or who is someone or something. </mark> </p> \
        If you had to rate your level of confusion following this exercise, you would say that you were:",
  ...
  */
  ...
  function AddHTMLElements(currentQuestion) {
    if (currentQuestion.exemple) {
      output.push(
        `<div class="slide">
           <div class="question">Part 1 Abstract and Spatial Reasoning Test: Example</div>
      ...
      output.push(
        `<div class="slide">
           <div class="question">Part 1 Abstract and Spatial Reasoning Test: It’s Up to You!</div>
